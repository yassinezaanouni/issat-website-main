...
function page() {
  ...
  return (
    <div>
      ...
      {selectedGroupId && <TimeTable selectedGroupId={selectedGroupId} />}
    </div>
  );
}
...
function TimeTable({ selectedGroupId }: { selectedGroupId: Id<"groups"> }) {
    ...
    <div>
      <div>
        <Button
          ...
          variant={item?.courses?.[number] ? "outline" : "default"}
        >
